            ...
            class PatientVisitScheduledScheduleVisit extends HTMLElement {
         constructor() {
    super();
  ...
  render() {
    this.shadowRoot.innerHTML = `
      ...
      <div>
        ...
        <form id="form">
            ...
            <label for="visit.visitType">Visit Type</label>
            <input type="text" id="visit.visitType" name="visit.visitType" value="${this._formData["visit.visitType"] || ""}" />
    ...
    this.shadowRoot.querySelector("form").onsubmit = (e) => {
      ...
      data["visit.visitType"] = this.shadowRoot.querySelector("#visit.visitType").value;
      this._formData = data;
...
customElements.define("patient-visit-scheduled-schedule-visit", PatientVisitScheduledScheduleVisit);
export default PatientVisitScheduledScheduleVisit;
