            ...
            class PatientVisitSampleCollectionCollectSpecimenAndCreateLabRequest extends HTMLElement {
         constructor() {
    super();
  ...
  render() {
    this.shadowRoot.innerHTML = `
      <style>/* styling */</style>
      <div>
        <h2>Collect specimen and create lab request</h2>
        <form id="form">
...
customElements.define("patient-visit-sample-collection-collect-specimen-and-create-lab-request", PatientVisitSampleCollectionCollectSpecimenAndCreateLabRequest);
export default PatientVisitSampleCollectionCollectSpecimenAndCreateLabRequest;
